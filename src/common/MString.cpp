...
unsigned String::length() const { return _super.length(); }

const char *String::ascii() const { return _super.c_str(); }

char String::operator[](int index) const { return _super[index]; }

char &String::operator[](int index) { return _super[index]; }
...
String String::operator+(const char *other) const { return _super + other; }

String String::operator+=(const String &other) {
  return _super += other._super;
}

String String::operator+=(const char *other) { return _super += other; }
