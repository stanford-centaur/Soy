...
const void *ConstSimpleData::data() const { return _data; }

unsigned ConstSimpleData::size() const { return _size; }

const char *ConstSimpleData::asChar() const { return (char *)_data; }
