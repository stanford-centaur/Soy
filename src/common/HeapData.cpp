...
HeapData::HeapData(HeapData &other) : _data(0), _size(0) { (*this) += other; }
...
HeapData::~HeapData() { freeMemoryIfNeeded(); }
...
void *HeapData::data() { return _data; }

const void *HeapData::data() const { return _data; }

unsigned HeapData::size() const { return _size; }

void HeapData::clear() { freeMemoryIfNeeded(); }

const char *HeapData::asChar() const { return (char *)_data; }

bool HeapData::allocated() const { return _data != NULL; }
...
void HeapData::adjustSize(unsigned size) { _size += size; }
