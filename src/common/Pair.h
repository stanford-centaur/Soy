...
class Pair {
 ...
 public:
  ...
  L &first() { return _container.first; }

  const L &first() const { return _container.first; }

  R &second() { return _container.second; }

  const R &second() const { return _container.second; }
