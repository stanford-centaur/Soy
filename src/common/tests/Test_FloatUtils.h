...
class FloatUtilsTestSuite : public CxxTest::TestSuite {
 public:
  void test_floatUtils() {
    ...
    TS_ASSERT_EQUALS(FloatUtils::doubleToString(0.1321211),
                     String("0.1321211"));
  ...
  void test_isint() {
    ...
    TS_ASSERT(FloatUtils::isInteger(-1, epsilon));
    TS_ASSERT(FloatUtils::isInteger(-0.9999999, epsilon));
    TS_ASSERT(FloatUtils::isInteger(-1.0000001, epsilon));
    TS_ASSERT(!FloatUtils::isInteger(-1.5, epsilon));

    TS_ASSERT(!FloatUtils::isInteger(-0.1, epsilon));
    TS_ASSERT(FloatUtils::isInteger(-0.0000001, epsilon));
    TS_ASSERT(FloatUtils::isInteger(0, epsilon));
    TS_ASSERT(FloatUtils::isInteger(0.0000001, epsilon));
    TS_ASSERT(!FloatUtils::isInteger(0.1, epsilon));
    ...
    TS_ASSERT(FloatUtils::isInteger(0.9999999, epsilon));
    TS_ASSERT(FloatUtils::isInteger(1.0000001, epsilon));
    TS_ASSERT(!FloatUtils::isInteger(1.3, epsilon));
  }
};
