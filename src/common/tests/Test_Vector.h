...
class VectorTestSuite : public CxxTest::TestSuite {
 public:
  ...
  void test_erase() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.erase("Bla"), const CommonError &e,
                            e.getCode(),
  ...
  void test_eraseByValue() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.eraseByValue("Bla"), const CommonError &e,
                            e.getCode(),
                            CommonError::VALUE_DOESNT_EXIST_IN_VECTOR);
  ...
  void test_erase_at() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.eraseAt(17), const CommonError &e,
                            e.getCode(), CommonError::VECTOR_OUT_OF_BOUNDS);
  }
  ...
  void test_pop_first() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.popFirst(), const CommonError &e,
                            e.getCode(),
  ...
  void test_pop() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.pop(), const CommonError &e, e.getCode(),
                            CommonError::POPPING_FROM_EMPTY_VECTOR);
  }
  ...
  void test_first() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.first(), const CommonError &e, e.getCode(),
  ...
  void test_last() {
    ...
    TS_ASSERT_THROWS_EQUALS(vector.last(), const CommonError &e, e.getCode(),
                            CommonError::VECTOR_OUT_OF_BOUNDS);
  ...
  void test_cartesian_product() {
    ...
    Vector<int>::cartesian(v, results);

    TS_ASSERT_EQUALS(results.size(), 8u);

    TS_ASSERT(results.exists({1, 3, 5}));
    TS_ASSERT(results.exists({1, 3, 6}));
    TS_ASSERT(results.exists({1, 4, 5}));
    TS_ASSERT(results.exists({1, 4, 6}));
    TS_ASSERT(results.exists({2, 3, 5}));
    TS_ASSERT(results.exists({2, 3, 6}));
    TS_ASSERT(results.exists({2, 4, 5}));
    TS_ASSERT(results.exists({2, 4, 6}));
  }
};
