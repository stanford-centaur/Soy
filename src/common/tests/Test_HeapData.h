...
class MockForHeapData : public T::Base_malloc,
                        public T::Base_free,
...
class HeapDataTestSuite : public CxxTest::TestSuite {
 public:
  ...
  void setUp() { TS_ASSERT(mock = new MockForHeapData); }
  ...
  void test_concatenation() {
    ...
    TS_ASSERT_THROWS_NOTHING(heapData +=
                             ConstSimpleData(buffer2, sizeof(buffer2)));
