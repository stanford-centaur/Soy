...
class MapTestSuite : public CxxTest::TestSuite {
 public:
  ...
  void test_erase() {
    ...
    TS_ASSERT_THROWS_EQUALS(map.erase(1), const CommonError &e, e.getCode(),
  ...
  void test_get() {
    ...
    TS_ASSERT_THROWS_EQUALS(map.at(4), const CommonError &e, e.getCode(),
                            CommonError::KEY_DOESNT_EXIST_IN_MAP);
  }
  ...
  void test_key_with_largest_value() {
    ...
    TS_ASSERT_THROWS_EQUALS(map.keyWithLargestValue(), const CommonError &e,
                            e.getCode(), CommonError::MAP_IS_EMPTY);
  ...
  void test_key_by_value() {
    ...
    TS_ASSERT_THROWS_EQUALS(map.keyByValue("wrong value"), const CommonError &e,
                            e.getCode(), CommonError::KEY_DOESNT_EXIST_IN_MAP);
  }
};
